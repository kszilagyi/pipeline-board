...
object ParallelJobManagerTest  extends TestSuite {
  ...
  def tests = TestSuite {
    'OneElement {
      ...
      overlappingIslands(Traversable(b1)) ==> Traversable(Island(List(b1)))
    }

    'MultipleSeparateElements {
      val b1 = buildInfo(1, 2)
      val b2 = buildInfo(3, 4)
      overlappingIslands(Traversable(b1, b2)) ==> Traversable(Island(List(b1)), Island(List(b2)))
    }

    'TwoOverlappingElement {
      val b1 = buildInfo(1, 10)
      val b2 = buildInfo(3, 5)
      overlappingIslands(Traversable(b1, b2)) ==> Traversable(Island(List(b1, b2)))
    }
    ...
    'TwoOverlappingElementAndOneNot {
      ...
      overlappingIslands(Traversable(b1, b2, b3)) ==> Traversable(Island(List(b1, b2)), Island(List(b3)))
    }
    ...
    'ThreeOverlappingElementWithMax2 {
      ...
      overlappingIslands(Traversable(b1, b2, b3)) ==> Traversable(Island(List(b1, b2, b3)))
    }
    ...
    'ThreeOverlappingElementWithMax2WrongOrder {
      ...
      val b2 = buildInfo(5, 20)
      val b3 = buildInfo(15, 25)
      overlappingIslands(Traversable(b3, b2, b1)) ==> Traversable(Island(List(b1, b2, b3)))
    }
    ...
    'SlotifiyingOne {
      val b1 = buildInfo(1, 10)
      slotify(Traversable(Island(List(b1)))) ==> Traversable(SlottedIsland(Map(Slot(0) -> List(b1))))
    }

    'SlotifiyingTwoIndependent {
      val b1 = buildInfo(1, 10)
      val b2 = buildInfo(11, 20)
      slotify(Traversable(Island(List(b1)), Island(List(b2)))) ==>
        Traversable(
    ...
    'SlotifyingTwoInTheSameIsland {
      val b1 = buildInfo(1, 10)
      val b2 = buildInfo(5, 20)
      slotify(Traversable(Island(List(b1, b2)))) ==>
        Traversable(
          SlottedIsland(Map(
            Slot(0) -> List(b1),
            Slot(1) -> List(b2)
    ...
    'SlotifyingThreeInTheSameIsland3OverLapping {
      ...
      slotify(Traversable(Island(List(b1, b2, b3)))) ==>
        Traversable(
          SlottedIsland(Map(
            Slot(0) -> List(b1),
            Slot(1) -> List(b2),
